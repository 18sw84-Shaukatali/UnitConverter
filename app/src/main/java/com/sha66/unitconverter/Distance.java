...
public class Distance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.dunits, android.R.layout.simple_spinner_item);
    ...
    public void convert(View view) {
        ...
        Converter1.Unit fromUnit = Converter1.Unit.fromString(fromString);
        Converter1.Unit toUnit = Converter1.Unit.fromString(toString);

        Converter1 converter = new Converter1(fromUnit, toUnit);
